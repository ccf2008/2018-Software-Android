...
public class Mymarket extends AppCompatActivity { // 내가 등록한 장터 상품들을 보여주는 화면, 내 정보에서 내 장터를 클릭하면 표시된다
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(Mymarket.this);
        ...
        btn_1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                mItem.clear();
                mItem2.clear();
                mAdapter = new ItemAdapter(mItem, mItem2,Mymarket.this,"1");
                ...
                myRef.orderByChild("uid").equalTo(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(check == false){
                            ...
                            Item item = new Item();
                            mItem2.add(item);
                            SharedPreferences auto = getSharedPreferences("myitem", Activity.MODE_PRIVATE);
