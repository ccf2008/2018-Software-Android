...
public class Myoction extends AppCompatActivity {  // 내가 등록한 경매 상품들을 보여주는 화면, 내 정보에서 내 경매를 누르면 표시된다
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myoction);
        ...
        mLayoutManager = new LinearLayoutManager(Myoction.this);
        ...
        btn_1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                mItem.clear();
                mItem2.clear();
                mAdapter = new OcItemAdapter(mItem, mItem2,Myoction.this,"1");
                ...
                myRef.orderByChild("uid").equalTo(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(check == false){
                            ...
                            mItem2.add(item);
                            SharedPreferences auto = getSharedPreferences("myoctionitem", Activity.MODE_PRIVATE);
